...
var GameLayer = cc.Layer.extend({
    ...
    ctor: function () {
        ...
        stencil.drawRect(cc.p(this.mapPanel.x,this.mapPanel.y - Constant.CANDY_WIDTH/2),
        		cc.p(this.mapPanel.x+Constant.CANDY_WIDTH*Constant.MAP_SIZE,
        				this.mapPanel.y+Constant.CANDY_WIDTH*(Constant.MAP_SIZE + 0.5)),
    ...
    _init: function () {
        ...
        for (var i = 0; i < Constant.MAP_SIZE; i++) {
            ...
            for (var j = 0; j < Constant.MAP_SIZE; j++) {
                ...
                candy.y = j * Constant.CANDY_WIDTH + (i % 2) * Constant.CANDY_WIDTH/2;
                column.push(candy);
            }
